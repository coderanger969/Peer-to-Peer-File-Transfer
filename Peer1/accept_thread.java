...
class accept_thread implements Runnable{
	...
	public  ArrayList<String> tempRlist1=new ArrayList<String>();
	 String RFC_Fname;
	// public static ArrayList<String> RFCList=new ArrayList<String>();
	  accept_thread(ServerSocket welsocket,String RFCFolder,ArrayList<String> tempRlist)
	 {
		...
		//RFCList=Rlist1;
		//System.out.println("in Accept Peer A");
		Thread t= new Thread(this,"Accept Thread A");
		t.start();
		RFC_Fname=RFCFolder;
	 }
			...
			while(true)
			{
				...
				//	RpeerPort=Integer.parseInt(result[1]);
					...
					if(cmd.equals("REQRF")){
						...
						//Pereq.sendRfc();
						Accept_output.writeObject(tempRlist1);
